# -*- coding: utf-8 -*-
"""
Created on Sun Nov 10 16:35:26 2019
...
#solve ODE
m = 22.9
X1 = odeint(model, X0, L, args=(m,))
m = 13.7
X2 = odeint(model, X0, L, args=(m,))
m = 9.16
X3 = odeint(model, X0, L, args=(m,))
m = 4.57
X4 = odeint(model, X0, L, args=(m,))

#plot results
plt.plot(L, X1, 'r-', linewidth=2,label='m=22.9')
plt.plot(L, X2, 'b--', linewidth=2,label='m=13.7')
plt.plot(L, X3, 'g:', linewidth=2,label='m=9.16')
plt.plot(L, X4, 'y+', linewidth=2,label='m=4.57')
plt.xlabel('Length (m)')
